...
class PassCoordinateModelCatBoost:
    """CatBoost 기반 패스 좌표 예측 모델"""
...
if __name__ == '__main__':
    print("🎯 K리그 패스 좌표 예측 - CatBoost 모델\n")
    ...
    # 모델 학습
    model = PassCoordinateModelCatBoost()
    results = model.train(df, n_folds=5)
    
    # 모델 저장
    model.save('catboost_model_v1.pkl')
