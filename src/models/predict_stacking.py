"""
Stacking 앙상블 예측 스크립트

1. Base 모델 3개를 전체 Train 데이터로 학습
2. Test 데이터 예측 (3개 모델)
3. Meta-Learner로 최종 조합
4. 제출 파일 생성
...
if len(categorical_cols) > 0:
    ...
    for col in categorical_cols:
        ...
        label_encoders[col] = le  # Test용으로 저장
...
# ===================================================================
print("\n" + "=" * 60)
print("STEP 2: Meta-Learner 로드")
print("=" * 60)

print("\n📂 LightGBM Meta-Learner 로드 중...")
...
output_path = SUBMISSION_DIR / 'submission_stacking_lgb.csv'
