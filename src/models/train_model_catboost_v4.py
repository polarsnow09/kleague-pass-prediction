...
def train_catboost_model(df: pd.DataFrame, n_folds: int = 5):
    """CatBoost 학습"""
    print("=" * 60)
    print("🚀 CatBoost 모델 학습 시작 (Phase 4)")
    print("=" * 60)
    ...
    model_path = MODEL_DIR / 'catboost_model_v4.pkl'
...
if __name__ == '__main__':
    print("🎯 K리그 패스 좌표 예측 - CatBoost v4 (Phase 4)\n")
